...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='ProductCharactheristicsCategory',
            fields=[
        ...
        migrations.CreateModel(
            name='ProductCharactheristics',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, null=True, verbose_name='Charactheristic name')),
                ('value', models.CharField(max_length=200, verbose_name='Value')),
                ('charactheristic_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='charactherisctics', to='products.productcharactheristicscategory', verbose_name='Category')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='charactheristics', to='products.products', verbose_name='Product')),
            ],
            options={
                'verbose_name': 'description',
                'verbose_name_plural': 'Descriptions',
